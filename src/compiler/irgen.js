...
const IROptimizerInstance = new IROptimizer();
...
class IRGenerator {
    ...
    generate () {
        ...
        IROptimizerInstance.optimizeScript(entry, this.procedures);
        for (const code of Object.keys(this.procedures)) {
            IROptimizerInstance.optimizeScript(this.procedures[code], this.procedures);
        }
